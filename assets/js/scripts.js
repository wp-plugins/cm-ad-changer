...
//			resize : {width : 320, height : 240, quality : 90}
        ...
        CM_AdsChanger.uploader.bind('FileUploaded', function(up, file, response){
            ...
            if(!pattern.test(response.response)){
                ...
                html += '<td><input type="text" name="banner_title[]" id="new_banner_title' + next_banner_index + '" maxlength="20" value="' + banner_title + '" /></td>';
                html += '</tr>';
                html += '<tr>';
                ...
                html += '<td><input type="text" name="banner_title_tag[]" id="new_banner_title_tag' + next_banner_index + '" maxlength="20" /></td>';
                html += '</tr>';
                html += '<tr>';
                ...
                html += '<td><input type="text" name="banner_alt_tag[]" id="new_banner_alt_tag' + next_banner_index + '" maxlength="20" /></td>';
                html += '</tr>';
                html += '<tr>';
                ...
                html += '<td><input type="text" name="banner_link[]" id="new_banner_link' + next_banner_index + '" maxlength="20" /></td>';
                html += '</tr>';
                html += '<tr>';
