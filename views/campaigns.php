...
<script>
    ...
    var plugin_url = '<?php echo ACF_PLUGIN_URL ?>';
...
<div class="wrap ad_changer">
    ...
    if( $success ) echo '<div class="ac_success clear">' . $success . '</div>';
    ?>
                ...
                <tbody>
                    ...
                    foreach($campaigns as $campaign)
                    {
                        ...
                        <tr campaign_id="<?php echo $campaign->campaign_id ?>"<?php echo isset($fields_data['campaign_id']) && $fields_data['campaign_id'] == $campaign->campaign_id ? ' class="selected_campaign"' : '' ?>>
                            ...
                            <td class="actions">
                                <a href="<?php echo get_bloginfo('wpurl') ?>/wp-admin/admin.php?page=ac_server_campaigns&action=edit&campaign_id=<?php echo $campaign->campaign_id ?>"><img src="<?php echo ACF_PLUGIN_URL . '/assets/images/edit.png' ?>" /></a>
                                <a href="<?php echo get_bloginfo('wpurl') ?>/wp-admin/admin.php?page=ac_server_campaigns&action=delete&campaign_id=<?php echo $campaign->campaign_id ?>" class="delete_campaign_link"><img src="<?php echo ACF_PLUGIN_URL . '/assets/images/trash.png' ?>" /></a>
                            </td>
                        </tr>
                        <?php
                    }
    ...
    <div class="ac-edit-form">
        <form id="campaign_form" class="clear ac-form" <?php echo (isset($fields_data['title']) || (isset($_GET['acs_admin_action']) && $_GET['acs_admin_action'] == 'new_campaign' && empty($_POST)) ? 'style="display:block !important"' : '') ?> method="post">
            <?php
            if( isset($fields_data['campaign_id']) ) echo '<input type="hidden" name="campaign_id" value="' . $fields_data['campaign_id'] . '" />';
            ?>
                ...
                <table cellspacing=0 cellpadding=0 border=0 class="clear" id="campaign_fields">
                    <tr>
                        <td>
                            ...
                            <?php
                            if( isset($fields_data) && isset($fields_data['campaign_id']) ) echo '<br><strong>Campaign ID <div class="field_help" title="' . $label_descriptions['campaign_id'] . '"></div> :' . $fields_data['campaign_id'] . '</strong>';
                            ?>
                        </td>
                        <td>
                            ...
                            <div id="container">
                                ...
                                <div id="filelist" class="clear">
                                    ...
                                    if( isset($fields_data['banner_filename']) )
                                    {
                                        ...
                                        {
                                            $clicks_rate = 0;
                                            if( (int) $fields_data['banner_clicks_cnt'][$banner_index] > 0 ) $clicks_rate = round(((int) $fields_data['banner_clicks_cnt'][$banner_index] / (int) $fields_data['banner_impressions_cnt'][$banner_index]) * 100);
                                            ...
                                            echo '<div class="plupload_image">
												...
												<table class="banner_info" border=0>
													<tr><td><label for="banner_title' . $banner_index . '">Name</label><div class="field_help" title="' . $label_descriptions['banner_title'] . '"></div></td><td><input type="text" name="banner_title[]" id="banner_title' . $banner_index . '" maxlength="150" value="' . (isset($fields_data['banner_title'][$banner_index]) ? $fields_data['banner_title'][$banner_index] : '') . '" /></td></tr>
													...
													<tr><td><label for="banner_alt_tag' . $banner_index . '">Banner Alt</label><div class="field_help" title="' . $label_descriptions['banner_alt_tag'] . '"></div></td><td><input type="text" name="banner_alt_tag[]" id="banner_alt_tag' . $banner_index . '" maxlength="150" value="' . (isset($fields_data['banner_alt_tag'][$banner_index]) ? $fields_data['banner_alt_tag'][$banner_index] : '') . '" /></td></tr>
													<tr><td><label for="banner_link' . $banner_index . '">Target URL</label><div class="field_help" title="' . $label_descriptions['banner_link'] . '"></div></td><td><input type="text" name="banner_link[]" id="banner_link' . $banner_index . '" maxlength="150" value="' . (isset($fields_data['banner_link'][$banner_index]) ? $fields_data['banner_link'][$banner_index] : '') . '" /></td></tr>
												...
												<img src="' . ACF_PLUGIN_URL . '/assets/images/close.png' . '" class="delete_button" />
											</div>';
                                        }

                                        if( isset($fields_data['selected_banner']) && !empty($fields_data['selected_banner']) ) echo '<script>
